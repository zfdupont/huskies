...
async def merge(shp_path="/data/GA/GAD.geojson", districts=False, write=True):
    ...
    if write: gdf.to_file('mergedGA.geojson', driver='GeoJSON')
    return gdf
