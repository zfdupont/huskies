...
async def merge():
    ...
    gdf2 = gpd.read_file('./data/IL/ILD.geojson')
    #make crs match
    if gdf.crs != gdf2.crs:
    ...
    gdf.to_file('mergedIL.geojson', driver='GeoJSON')
